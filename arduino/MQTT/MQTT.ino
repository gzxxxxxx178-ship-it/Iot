...
/* ================= 传感器引脚 (ESP8266) ================= */
// DHT11 温湿度传感器
#define DHTPIN  5       // GPIO5（NodeMCU/Wemos 上通常标为 D1）
#define DHTTYPE DHT11

// 水位传感器 (模拟输入)
#define WATER_PIN A0    // ESP8266 唯一的模拟输入引脚

/* ================= 阈值配置 ================= */
// ESP8266 ADC 为10位 (0-1023)
// 根据实际传感器调整阈值
float TEMP_THRESHOLD = 30.0;
int   WATER_THRESHOLD = 300;   // 按原阈值比例由12位ADC换算为10位ADC
