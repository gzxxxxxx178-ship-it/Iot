...
public class ChatController {
    ...
    // AI对话：保存用户消息、调用DeepSeek API、保存AI回复并返回
    ...
    public ResponseEntity<?> chat(@RequestBody ChatRequest request) {
        try {
            ...
            Map<String, String> err1 = new HashMap<>();
            err1.put("error", "DeepSeek API 响应异常");
            return ResponseEntity.status(500).body(err1);
        } catch (Exception e) {
            Map<String, String> err2 = new HashMap<>();
